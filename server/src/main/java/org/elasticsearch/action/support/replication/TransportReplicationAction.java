...
public abstract class TransportReplicationAction<
    ...
    protected void handlePrimaryRequest(final ConcreteShardRequest<Request> request, final TransportChannel channel, final Task task) {
        new AsyncPrimaryAction(request, new ChannelActionListener<>(channel, transportPrimaryAction, request), (ReplicationTask) task)
            .run();
    }
        ...
        public void onResponse(Releasable releasable) {
            try {
                ...
                replicaResult.runPostReplicaActions(ActionListener.wrap(r -> {
                    final TransportReplicationAction.ReplicaResponse response = new ReplicaResponse(
