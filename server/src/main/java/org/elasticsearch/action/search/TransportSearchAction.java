...
public class TransportSearchAction extends HandledTransportAction<SearchRequest, SearchResponse> {
    ...
    static BiFunction<String, String, DiscoveryNode> processRemoteShards(
    ...
    private Index[] resolveLocalIndices(
        OriginalIndices localIndices,
        IndicesOptions indicesOptions,
        ClusterState clusterState,
        SearchTimeProvider timeProvider
    ...
    private void executeSearch(
        ...
        GroupShardsIterator<SearchShardIterator> shardIterators = mergeShardsIterators(
            localShardsIterator,
            localIndices,
    ...
    private static boolean shouldPreFilterSearchShards(
        SearchRequest searchRequest,
