...
public final class DateHistogramAggregatorFactory extends ValuesSourceAggregatorFactory<ValuesSource> {
    ...
    protected ValuesSource resolveMissingAny(Object missing) {
        ...
        throw new IllegalArgumentException(
            "Only numeric missing values are supported for date histogram aggregation, found [" + missing + "]"
        );
    }
    ...
    protected Aggregator doCreateInternal(
        ...
        if (valuesSource instanceof ValuesSource.Numeric) {
            ...
            if (rangeValueSource.rangeType() != RangeType.DATE) {
                throw new IllegalArgumentException(
                    "Expected date range type but found range type [" + rangeValueSource.rangeType().name + "]"
                );
            }
    ...
    private Aggregator createRangeAggregator(
        ...
        return new DateRangeHistogramAggregator(
            name,
            factories,
            rounding,
            shardRounding,
