...
final class XLongDistanceFeatureQuery extends Query {

  private final String field;
  private final long origin;
  private final long pivotDistance;
  private final long globalMinValue;

  XLongDistanceFeatureQuery(String field, long minValue, long origin, long pivotDistance) {
  ...
  private boolean equalsTo(XLongDistanceFeatureQuery other) {
