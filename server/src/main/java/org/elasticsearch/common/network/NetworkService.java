...
public final class NetworkService {
    ...
    public static final Setting<Integer> TCP_KEEP_IDLE = Setting.intSetting("network.tcp.keep_idle", -1, -1, Property.NodeScope);
    public static final Setting<Integer> TCP_KEEP_INTERVAL = Setting.intSetting("network.tcp.keep_interval", -1, -1, Property.NodeScope);
