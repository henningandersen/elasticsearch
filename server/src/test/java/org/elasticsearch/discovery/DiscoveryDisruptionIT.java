...
public class DiscoveryDisruptionIT extends AbstractDisruptionTestCase {
    ...
    public void testElectMasterWithLatestVersion() throws Exception {
        ...
        final ServiceDisruptionScheme isolatePreferredMaster = new NetworkDisruption(
            new NetworkDisruption.TwoPartitions(Collections.singleton(preferredMasterName), nonPreferredNodes),
            new NetworkDisconnect()
        );
