...
public class GeoShapeFieldMapperTests extends ESSingleNodeTestCase {
    ...
    public void testGeoShapeMapperMerge() throws Exception {
        ...
        DocumentMapper docMapper = mapperService.merge(
            "type",
            new CompressedXContent(stage1Mapping),
        ...
        stage2Mapping = Strings.toString(
            XContentFactory.jsonBuilder()
                .startObject()
                .startObject("type")
                .startObject("properties")
    ...
    public void testSerializeDefaults() throws Exception {
        DocumentMapperParser parser = createIndex("test").mapperService().documentMapperParser();
        {
            ...
            assertTrue(
                serialized,
                serialized.contains("\"orientation\":\"" + AbstractGeometryFieldMapper.Defaults.ORIENTATION.value() + "\"")
            );
        }
    }
