...
public class DateFieldMapperTests extends ESSingleNodeTestCase {
    ...
    public void testDefaults() throws Exception {
        ...
        ParsedDocument doc = mapper.parse(
            new SourceToParse(
                "test",
                "1",
                BytesReference.bytes(XContentFactory.jsonBuilder().startObject().field("field", "2016-03-11").endObject()),
                XContentType.JSON
            )
        );
    ...
    public void testIgnoreMalformed() throws IOException {
        testIgnoreMalfomedForValue(
            "2016-03-99",
            "failed to parse date field [2016-03-99] with format [strict_date_optional_time||epoch_millis]"
        );
        testIgnoreMalfomedForValue("-2147483648", "Invalid value for Year (valid values -999999999 - 999999999): -2147483648");
    }
    ...
    public void testChangeFormat() throws IOException {
        ...
        ParsedDocument doc = mapper.parse(
            new SourceToParse(
                "test",
                "1",
                BytesReference.bytes(XContentFactory.jsonBuilder().startObject().field("field", 1457654400).endObject()),
                XContentType.JSON
            )
        );
        ...
        mapper.parse(
            new SourceToParse(
                ...
                BytesReference.bytes(
                    XContentFactory.jsonBuilder().startObject().field("field", "Mi, 06 Dez 2000 02:55:00 -0800").endObject()
                ),
                XContentType.JSON
            )
        );
    ...
    public void testTimeZoneParsing() throws Exception {
        ...
        ParsedDocument doc = mapper.parse(
            new SourceToParse(
                "test",
                "1",
                BytesReference.bytes(XContentFactory.jsonBuilder().startObject().field("field", formatter.format(randomDate)).endObject()),
                XContentType.JSON
            )
        );
    ...
    public void testMergeDate() throws IOException {
        String initMapping = Strings.toString(
            XContentFactory.jsonBuilder()
                .startObject()
                .startObject("movie")
                .startObject("properties")
        ...
        indexService.mapperService().merge("movie", new CompressedXContent(initMapping), MapperService.MergeReason.MAPPING_UPDATE);
        ...
        String updateFormatMapping = Strings.toString(
            XContentFactory.jsonBuilder()
                .startObject()
                .startObject("movie")
                .startObject("properties")
        ...
        Exception e = expectThrows(
            ...
            () -> indexService.mapperService()
                .merge("movie", new CompressedXContent(updateFormatMapping), MapperService.MergeReason.MAPPING_UPDATE)
        );
    ...
    public void testMergeText() throws Exception {
        ...
        String mappingUpdate = Strings.toString(
            XContentFactory.jsonBuilder()
                .startObject()
                .startObject("_doc")
                .startObject("properties")
        ...
        IllegalArgumentException e = expectThrows(IllegalArgumentException.class, () -> mapper.merge(update.mapping()));
