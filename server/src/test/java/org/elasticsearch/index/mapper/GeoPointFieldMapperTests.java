...
public class GeoPointFieldMapperTests extends ESSingleNodeTestCase {
    ...
    public void testGeoHashValue() throws Exception {
        ...
        ParsedDocument doc = defaultMapper.parse(
            new SourceToParse(
                "test",
                "1",
                BytesReference.bytes(XContentFactory.jsonBuilder().startObject().field("point", stringEncode(1.3, 1.2)).endObject()),
                XContentType.JSON
            )
        );
    ...
    public void testWKT() throws Exception {
        ...
        ParsedDocument doc = defaultMapper.parse(
            new SourceToParse(
                "test",
                "1",
                BytesReference.bytes(XContentFactory.jsonBuilder().startObject().field("point", "POINT (2 3)").endObject()),
                XContentType.JSON
            )
        );
    ...
    public void testLatLonInOneValue() throws Exception {
        ...
        ParsedDocument doc = defaultMapper.parse(
            new SourceToParse(
                "test",
                "1",
                BytesReference.bytes(XContentFactory.jsonBuilder().startObject().field("point", "1.2,1.3").endObject()),
                XContentType.JSON
            )
        );
    ...
    public void testLatLonStringWithZValue() throws Exception {
        ...
        ParsedDocument doc = defaultMapper.parse(
            new SourceToParse(
                "test",
                "1",
                BytesReference.bytes(XContentFactory.jsonBuilder().startObject().field("point", "1.2,1.3,10.0").endObject()),
                XContentType.JSON
            )
        );
    ...
    public void testLatLonInOneValueArray() throws Exception {
        ...
        ParsedDocument doc = defaultMapper.parse(
            new SourceToParse(
                ...
                "1",
                BytesReference.bytes(
                    XContentFactory.jsonBuilder().startObject().startArray("point").value("1.2,1.3").value("1.4,1.5").endArray().endObject()
                ),
                XContentType.JSON
            )
        );
    ...
    public void testLonLatArray() throws Exception {
        ...
        ParsedDocument doc = defaultMapper.parse(
            new SourceToParse(
                ...
                "1",
                BytesReference.bytes(
                    XContentFactory.jsonBuilder().startObject().startArray("point").value(1.3).value(1.2).endArray().endObject()
                ),
                XContentType.JSON
            )
        );
    ...
    public void testLonLatArrayArrayStored() throws Exception {
        ...
        String mapping = Strings.toString(
            xContentBuilder.field("store", true).field("doc_values", false).endObject().endObject().endObject().endObject()
        );
        DocumentMapper defaultMapper = createIndex("test").mapperService()
            .documentMapperParser()
            .parse("type", new CompressedXContent(mapping));
    ...
    public void testMultiField() throws Exception {
        ...
        String mapping = Strings.toString(
            XContentFactory.jsonBuilder()
                ...
                .startObject("geohash")
                .field("type", "keyword")
                .endObject()  // test geohash as keyword
                .startObject("latlon")
                .field("type", "keyword")
                .endObject()  // test geohash as string
                .endObject()
                .endObject()
                .endObject()
                .endObject()
        );
        CreateIndexRequestBuilder mappingRequest = client().admin().indices().prepareCreate("test").setMapping(mapping);
        ...
        SearchResponse searchResponse = client().prepareSearch()
            .addStoredField("location.geohash")
    ...
    public void testNullValue() throws Exception {
        ...
        ParsedDocument doc = defaultMapper.parse(
            new SourceToParse(
                "test",
                "1",
                BytesReference.bytes(XContentFactory.jsonBuilder().startObject().nullField("location").endObject()),
                XContentType.JSON
            )
        );
        ...
        doc = defaultMapper.parse(
            new SourceToParse(
                "test",
                "1",
                BytesReference.bytes(XContentFactory.jsonBuilder().startObject().field("location", "1, 2").endObject()),
                XContentType.JSON
            )
        );
        ...
        doc = defaultMapper.parse(
            new SourceToParse(
                "test",
                "1",
                BytesReference.bytes(XContentFactory.jsonBuilder().startObject().field("location", "3, 4").endObject()),
                XContentType.JSON
            )
        );
        // Shouldn't matter if we specify the value explicitly or use null value
    ...
    public void testInvalidGeohashIgnored() throws Exception {
        ...
        ParsedDocument doc = defaultMapper.parse(
            new SourceToParse(
                "test",
                "1",
                BytesReference.bytes(XContentFactory.jsonBuilder().startObject().field("location", "1234.333").endObject()),
                XContentType.JSON
            )
        );
        ...
        assertThat(
            defaultMapper.parse(
                new SourceToParse(
                    "test",
                    "1",
                    BytesReference.bytes(XContentFactory.jsonBuilder().startObject().field("lat", "-").field("lon", 1.3).endObject()),
                    XContentType.JSON
                )
            ).rootDoc().getField("location"),
            nullValue()
        ...
        assertThat(
            defaultMapper.parse(
                new SourceToParse(
                    "test",
                    "1",
                    BytesReference.bytes(XContentFactory.jsonBuilder().startObject().field("lat", 1.3).field("lon", "-").endObject()),
                    XContentType.JSON
                )
            ).rootDoc().getField("location"),
            nullValue()
        ...
        assertThat(
            defaultMapper.parse(
                new SourceToParse(
                    "test",
                    "1",
                    BytesReference.bytes(XContentFactory.jsonBuilder().startObject().field("location", "-,1.3").endObject()),
                    XContentType.JSON
                )
            ).rootDoc().getField("location"),
            nullValue()
        ...
        assertThat(
            defaultMapper.parse(
                new SourceToParse(
                    "test",
                    "1",
                    BytesReference.bytes(XContentFactory.jsonBuilder().startObject().field("lat", "NaN").field("lon", "NaN").endObject()),
                    XContentType.JSON
                )
            ).rootDoc().getField("location"),
            nullValue()
        ...
        assertThat(
            defaultMapper.parse(
                new SourceToParse(
                    "test",
                    "1",
                    BytesReference.bytes(XContentFactory.jsonBuilder().startObject().field("lat", 12).field("lon", "NaN").endObject()),
                    XContentType.JSON
                )
            ).rootDoc().getField("location"),
            nullValue()
        ...
        assertThat(
            defaultMapper.parse(
                new SourceToParse(
                    "test",
                    "1",
                    BytesReference.bytes(XContentFactory.jsonBuilder().startObject().field("lat", "NaN").field("lon", 10).endObject()),
                    XContentType.JSON
                )
            ).rootDoc().getField("location"),
            nullValue()
        ...
        assertThat(
            defaultMapper.parse(
                new SourceToParse(
                    "test",
                    "1",
                    BytesReference.bytes(XContentFactory.jsonBuilder().startObject().field("location", "NaN,NaN").endObject()),
                    XContentType.JSON
                )
            ).rootDoc().getField("location"),
            nullValue()
        ...
        assertThat(
            defaultMapper.parse(
                new SourceToParse(
                    "test",
                    "1",
                    BytesReference.bytes(XContentFactory.jsonBuilder().startObject().field("location", "10,NaN").endObject()),
                    XContentType.JSON
                )
            ).rootDoc().getField("location"),
            nullValue()
        ...
        assertThat(
            defaultMapper.parse(
                new SourceToParse(
                    "test",
                    "1",
                    BytesReference.bytes(XContentFactory.jsonBuilder().startObject().field("location", "NaN,12").endObject()),
                    XContentType.JSON
                )
            ).rootDoc().getField("location"),
            nullValue()
