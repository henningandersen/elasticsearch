...
public class ExternalValuesMapperIntegrationIT extends ESIntegTestCase {
    ...
    public void testHighlightingOnCustomString() throws Exception {
        ...
        index("test-idx", "1", XContentFactory.jsonBuilder().startObject().field("field", "Every day is exactly the same").endObject());
        refresh();
    ...
    public void testExternalValues() throws Exception {
        ...
        index("test-idx", "1", XContentFactory.jsonBuilder().startObject().field("field", "1234").endObject());
        refresh();
