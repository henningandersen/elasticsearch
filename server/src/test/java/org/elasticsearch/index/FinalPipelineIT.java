...
public class FinalPipelineIT extends ESIntegTestCase {
    ...
    public static class TestPlugin extends Plugin implements IngestPlugin {
        ...
        public Map<String, Processor.Factory> getProcessors(Processor.Parameters parameters) {
            return Map.of("default", (factories, tag, config) -> new AbstractProcessor(tag) {
            ...
            }, "final", (processorFactories, tag, config) -> {
            ...
            }, "request", (processorFactories, tag, config) -> new AbstractProcessor(tag) {
                @Override
                public IngestDocument execute(final IngestDocument ingestDocument) throws Exception {
