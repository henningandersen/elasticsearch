...
public class MultiMatchQueryBuilderTests extends AbstractQueryTestCase<MultiMatchQueryBuilder> {
    ...
    public void testToQueryMultipleFieldsDisableDismax() throws Exception {
        Query query = multiMatchQuery("test").field(STRING_FIELD_NAME)
            ...
            context.getIndexSettings()
                .updateIndexMetaData(
                    newIndexMeta(
                        ...
                        context.getIndexSettings().getSettings(),
                        Settings.builder()
                            .putList("index.query.default_field", STRING_FIELD_NAME, STRING_FIELD_NAME_2 + "^5", INT_FIELD_NAME)
                            .build()
                    )
                );
    ...
    public void testAllFieldsWildcard() throws Exception {
        ...
        query = new MultiMatchQueryBuilder("hello").field(STRING_FIELD_NAME).field("*").field(STRING_FIELD_NAME_2).toQuery(context);
        assertQueryWithAllFieldsWildcard(query);
    }

    public void testWithStopWords() throws Exception {
        Query query = new MultiMatchQueryBuilder("the quick fox").field(STRING_FIELD_NAME).analyzer("stop").toQuery(createShardContext());
        ...
        query = new MultiMatchQueryBuilder("the quick fox").field(STRING_FIELD_NAME)
            .field(STRING_FIELD_NAME_2)
            .analyzer("stop")
            .toQuery(createShardContext());
        expected = new DisjunctionMaxQuery(
            Arrays.asList(
                new BooleanQuery.Builder().add(new TermQuery(new Term(STRING_FIELD_NAME, "quick")), BooleanClause.Occur.SHOULD)
                    .add(new TermQuery(new Term(STRING_FIELD_NAME, "fox")), BooleanClause.Occur.SHOULD)
                    .build(),
                new BooleanQuery.Builder().add(new TermQuery(new Term(STRING_FIELD_NAME_2, "quick")), BooleanClause.Occur.SHOULD)
        ...
        query = new MultiMatchQueryBuilder("the").field(STRING_FIELD_NAME)
            .field(STRING_FIELD_NAME_2)
            .analyzer("stop")
            .toQuery(createShardContext());
        ...
        query = new BoolQueryBuilder().should(new MultiMatchQueryBuilder("the").field(STRING_FIELD_NAME).analyzer("stop"))
            .toQuery(createShardContext());
        ...
        query = new BoolQueryBuilder().should(
            new MultiMatchQueryBuilder("the").field(STRING_FIELD_NAME).field(STRING_FIELD_NAME_2).analyzer("stop")
        ).toQuery(createShardContext());
    ...
    public void testNegativeFieldBoost() {
        IllegalArgumentException exc = expectThrows(
            ...
            () -> new MultiMatchQueryBuilder("the quick fox").field(STRING_FIELD_NAME, -1.0f)
                .field(STRING_FIELD_NAME_2)
                .toQuery(createShardContext())
        );
