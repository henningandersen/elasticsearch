...
public class IntervalQueryBuilderTests extends AbstractQueryTestCase<IntervalQueryBuilder> {
    ...
    public void testMatchInterval() throws IOException {
        ...
        String json = "{ \"intervals\" : " + "{ \"" + STRING_FIELD_NAME + "\" : { \"match\" : { \"query\" : \"Hello world\" } } } }";

        IntervalQueryBuilder builder = (IntervalQueryBuilder) parseQuery(json);
        Query expected = new IntervalQuery(STRING_FIELD_NAME, Intervals.unordered(Intervals.term("hello"), Intervals.term("world")));
        ...
        expected = new BoostQuery(
            new IntervalQuery(STRING_FIELD_NAME, Intervals.ordered(Intervals.term("hello"), Intervals.term("world"))),
            2
        );
        assertEquals(expected, builder.toQuery(createShardContext()));
    ...
    public void testOrInterval() throws IOException {
        ...
        String json = "{ \"intervals\" : { \""
            ...
            + "               { \"match\" : { \"query\" : \"two\" } } ] } } } }";
        IntervalQueryBuilder builder = (IntervalQueryBuilder) parseQuery(json);
        Query expected = new IntervalQuery(STRING_FIELD_NAME, Intervals.or(Intervals.term("one"), Intervals.term("two")));
        assertEquals(expected, builder.toQuery(createShardContext()));
    ...
    public void testPrefixes() throws IOException {
        ...
        String json = "{ \"intervals\" : { \"" + STRING_FIELD_NAME + "\": { " + "\"prefix\" : { \"prefix\" : \"term\" } } } }";
        IntervalQueryBuilder builder = (IntervalQueryBuilder) parseQuery(json);
    ...
    public void testWildcard() throws IOException {
        ...
        String json = "{ \"intervals\" : { \"" + STRING_FIELD_NAME + "\": { " + "\"wildcard\" : { \"pattern\" : \"Te?m\" } } } }";
    ...
    public void testFuzzy() throws IOException {
        ...
        String json = "{ \"intervals\" : { \"" + STRING_FIELD_NAME + "\": { " + "\"fuzzy\" : { \"term\" : \"Term\" } } } }";
        IntervalQueryBuilder builder = (IntervalQueryBuilder) parseQuery(json);
        ...
        expected = new IntervalQuery(STRING_FIELD_NAME, buildFuzzySource("term", "Term", 2, true, Fuzziness.AUTO.asDistance("term")));
        assertEquals(expected, builder.toQuery(createShardContext()));
        ...
        expected = new IntervalQuery(STRING_FIELD_NAME, buildFuzzySource("term", "Term", 2, true, Fuzziness.ONE.asDistance("term")));
        assertEquals(expected, builder.toQuery(createShardContext()));
        ...
        expected = new IntervalQuery(STRING_FIELD_NAME, buildFuzzySource("term", "Term", 2, false, Fuzziness.AUTO.asDistance("term")));
        assertEquals(expected, builder.toQuery(createShardContext()));
