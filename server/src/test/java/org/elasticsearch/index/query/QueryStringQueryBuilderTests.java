...
public class QueryStringQueryBuilderTests extends AbstractQueryTestCase<QueryStringQueryBuilder> {
    ...
    protected QueryStringQueryBuilder doCreateTestQueryBuilder() {
        ...
        if (randomBoolean()) {
            String defaultFieldName = randomFrom(STRING_FIELD_NAME, STRING_ALIAS_FIELD_NAME, randomAlphaOfLengthBetween(1, 10));
    ...
    public void testToQueryMultipleTermsBooleanQuery() throws Exception {
        Query query = queryStringQuery("test1 test2").field(STRING_FIELD_NAME).toQuery(createShardContext());
    ...
    public void testToQueryMultipleFieldsBooleanQuery() throws Exception {
        Query query = queryStringQuery("test").field(STRING_FIELD_NAME).field(STRING_FIELD_NAME_2).toQuery(createShardContext());
    ...
    public void testToQueryDisMaxQuery() throws Exception {
        Query query = queryStringQuery("test").field(STRING_FIELD_NAME, 2.2f).field(STRING_FIELD_NAME_2).toQuery(createShardContext());
        assertThat(query, instanceOf(DisjunctionMaxQuery.class));
        DisjunctionMaxQuery disMaxQuery = (DisjunctionMaxQuery) query;
        List<Query> disjuncts = disMaxQuery.getDisjuncts();
    ...
    public void testToQueryWildcardQuery() throws Exception {
        for (Operator op : Operator.values()) {
            ...
            Query expectedQuery = new BooleanQuery.Builder().add(
                new BooleanClause(new TermQuery(new Term(STRING_FIELD_NAME, "first")), defaultOp)
            )
                .add(
                    new BooleanQuery.Builder().add(new BooleanClause(new TermQuery(new Term(STRING_FIELD_NAME, "foo")), defaultOp))
    ...
    public void testToQueryWilcardQueryWithSynonyms() throws Exception {
        for (Operator op : Operator.values()) {
            ...
            Query expectedQuery = new BooleanQuery.Builder().add(
                new BooleanClause(new SynonymQuery(new Term(STRING_FIELD_NAME, "first"), new Term(STRING_FIELD_NAME, "first")), defaultOp)
            )
                .add(
                    new BooleanQuery.Builder().add(
                        new BooleanClause(
                            new SynonymQuery(new Term(STRING_FIELD_NAME, "foo"), new Term(STRING_FIELD_NAME, "foo")),
                            defaultOp
                        )
                    )
                        .add(
                            new BooleanClause(
                                new SynonymQuery(new Term(STRING_FIELD_NAME, "bar"), new Term(STRING_FIELD_NAME, "bar")),
                                defaultOp
                            )
                        )
                        .add(
                            new BooleanQuery.Builder().add(
                                new BooleanClause(new PrefixQuery(new Term(STRING_FIELD_NAME, "foobar")), BooleanClause.Occur.SHOULD)
                            )
                                .add(new BooleanClause(new PrefixQuery(new Term(STRING_FIELD_NAME, "foobar")), BooleanClause.Occur.SHOULD))
                                .build(),
                            defaultOp
                        )
                        .build(),
                ...
                .add(
                    new BooleanClause(new SynonymQuery(new Term(STRING_FIELD_NAME, "last"), new Term(STRING_FIELD_NAME, "last")), defaultOp)
                )
                .build();
            assertThat(query, Matchers.equalTo(expectedQuery));
        }
    ...
    public void testToQueryWithGraph() throws Exception {
        for (Operator op : Operator.values()) {
            ...
            Query guineaPig = new BooleanQuery.Builder().add(new TermQuery(new Term(STRING_FIELD_NAME, "guinea")), Occur.MUST)
            ...
            expectedQuery = new BooleanQuery.Builder().add(
                new BooleanQuery.Builder().add(
                    new PhraseQuery.Builder().add(new Term(STRING_FIELD_NAME, "guinea")).add(new Term(STRING_FIELD_NAME, "pig")).build(),
                    Occur.SHOULD
                ).add(new TermQuery(new Term(STRING_FIELD_NAME, "cavy")), Occur.SHOULD).build(),
                defaultOp
            ).build();
            assertThat(query, Matchers.equalTo(expectedQuery));
            queryParser.setAutoGenerateMultiTermSynonymsPhraseQuery(false);
            ...
            expectedQuery = new BooleanQuery.Builder().add(new TermQuery(new Term(STRING_FIELD_NAME, "that")), defaultOp)
            ...
            // complex
            query = queryParser.parse("+that -(guinea pig) +smells");
            expectedQuery = new BooleanQuery.Builder().add(new TermQuery(new Term(STRING_FIELD_NAME, "that")), Occur.MUST)
                .add(
                    new BooleanQuery.Builder().add(
                        new BooleanQuery.Builder().add(guineaPig, Occur.SHOULD).add(cavy, Occur.SHOULD).build(),
                        defaultOp
            ...
            query = queryParser.parse("+that -guinea pig +smells");
            expectedQuery = new BooleanQuery.Builder().add(new TermQuery(new Term(STRING_FIELD_NAME, "that")), BooleanClause.Occur.MUST)
            ...
            expectedQuery = new SpanNearQuery.Builder(STRING_FIELD_NAME, true).addClause(
                new SpanTermQuery(new Term(STRING_FIELD_NAME, "that"))
            )
                .addClause(
                    new SpanOrQuery(
                        new SpanNearQuery.Builder(STRING_FIELD_NAME, true).addClause(
            ...
            PhraseQuery pq1 = new PhraseQuery.Builder().add(new Term(STRING_FIELD_NAME, "that"))
                .add(new Term(STRING_FIELD_NAME, "guinea"))
                .add(new Term(STRING_FIELD_NAME, "pig"))
                .add(new Term(STRING_FIELD_NAME, "smells"))
                .setSlop(2)
                .build();
            PhraseQuery pq2 = new PhraseQuery.Builder().add(new Term(STRING_FIELD_NAME, "that"))
    ...
    public void testToQueryFuzzyQueryAutoFuziness() throws Exception {
        for (int i = 0; i < 3; i++) {
            ...
            for (int j = 0; j < 2; j++) {
                Query query = queryStringQuery(queryString + (j == 0 ? "~" : "~auto")).defaultField(STRING_FIELD_NAME)
    ...
    public void testToQueryWildcardNonExistingFields() throws IOException {
        ...
        queryStringQueryBuilder = new QueryStringQueryBuilder(STRING_FIELD_NAME + ":foo bar").field("invalid*");
        query = queryStringQueryBuilder.toQuery(createShardContext());
        expectedQuery = new BooleanQuery.Builder().add(new TermQuery(new Term(STRING_FIELD_NAME, "foo")), Occur.SHOULD)
    ...
    public void testToQueryTextParsing() throws IOException {
        {
            QueryStringQueryBuilder queryBuilder = new QueryStringQueryBuilder("foo bar").field(STRING_FIELD_NAME)
                .field(STRING_FIELD_NAME_2);
            Query query = queryBuilder.toQuery(createShardContext());
            BooleanQuery bq1 = new BooleanQuery.Builder().add(
                new BooleanClause(new TermQuery(new Term(STRING_FIELD_NAME, "foo")), BooleanClause.Occur.SHOULD)
            ).add(new BooleanClause(new TermQuery(new Term(STRING_FIELD_NAME, "bar")), BooleanClause.Occur.SHOULD)).build();
        ...
        // type=phrase
        {
            ...
            List<Query> disjuncts = new ArrayList<>();
            PhraseQuery pq = new PhraseQuery.Builder().add(new Term(STRING_FIELD_NAME, "foo"))
        ...
        {
            QueryStringQueryBuilder queryBuilder = new QueryStringQueryBuilder("mapped_string:other foo bar").field(STRING_FIELD_NAME)
                .field(STRING_FIELD_NAME_2);
            Query query = queryBuilder.toQuery(createShardContext());
            BooleanQuery bq1 = new BooleanQuery.Builder().add(
                new BooleanClause(new TermQuery(new Term(STRING_FIELD_NAME, "foo")), BooleanClause.Occur.SHOULD)
        ...
        {
            QueryStringQueryBuilder queryBuilder = new QueryStringQueryBuilder("foo OR bar").field(STRING_FIELD_NAME)
                .field(STRING_FIELD_NAME_2);
            Query query = queryBuilder.toQuery(createShardContext());
    ...
    public void testUnmappedFieldRewriteToMatchNoDocs() throws IOException {
        ...
        // Multi block
        query = new QueryStringQueryBuilder("first unmapped:second").field(STRING_FIELD_NAME)
            .field("unmapped")
            .field("another_unmapped")
            .defaultOperator(Operator.AND)
            .toQuery(createShardContext());
        BooleanQuery expected = new BooleanQuery.Builder().add(
            new TermQuery(new Term(STRING_FIELD_NAME, "first")),
            BooleanClause.Occur.MUST
        ).add(new MatchNoDocsQuery(), BooleanClause.Occur.MUST).build();
            ...
            context.getIndexSettings()
                .updateIndexMetaData(
                    newIndexMeta(
                        ...
                        Settings.builder().putList("index.query.default_field", STRING_FIELD_NAME, "*", STRING_FIELD_NAME_2).build()
                    )
                );
            ...
            context.getIndexSettings()
                .updateIndexMetaData(
                    newIndexMeta(
                        "index",
                        context.getIndexSettings().getSettings(),
                        Settings.builder().putList("index.query.default_field", STRING_FIELD_NAME, STRING_FIELD_NAME_2 + "^5").build()
                    )
                );
            query = new QueryStringQueryBuilder("hello").toQuery(context);
    ...
    public void testAllFieldsWildcard() throws Exception {
        ...
        query = new QueryStringQueryBuilder("hello").field(STRING_FIELD_NAME).field("*").field(STRING_FIELD_NAME_2).toQuery(context);
        assertQueryWithAllFieldsWildcard(query);
    }
    ...
    public void testQuoteAnalyzer() throws Exception {
        // Prefix
        Query query = new QueryStringQueryBuilder("ONE \"TWO THREE\"").field(STRING_FIELD_NAME)
            .analyzer("whitespace")
            .quoteAnalyzer("simple")
            .toQuery(createShardContext());
        Query expectedQuery = new BooleanQuery.Builder().add(
            new BooleanClause(new TermQuery(new Term(STRING_FIELD_NAME, "ONE")), Occur.SHOULD)
        )
            .add(
                new BooleanClause(
                    new PhraseQuery.Builder().add(new Term(STRING_FIELD_NAME, "two"), 0)
    ...
    public void testQuoteFieldSuffix() throws IOException {
        ...
        assertEquals(
            ...
            new QueryStringQueryBuilder("bar").quoteFieldSuffix("_2").field(STRING_FIELD_NAME).doToQuery(context)
        );
        assertEquals(
            new TermQuery(new Term(STRING_FIELD_NAME_2, "bar")),
            new QueryStringQueryBuilder("\"bar\"").quoteFieldSuffix("_2").field(STRING_FIELD_NAME).doToQuery(context)
        );
        ...
        assertEquals(
            new TermQuery(new Term(STRING_FIELD_NAME, "bar")),
            new QueryStringQueryBuilder("bar").quoteFieldSuffix(".quote").field(STRING_FIELD_NAME).doToQuery(context)
        );
        assertEquals(
            new TermQuery(new Term(STRING_FIELD_NAME, "bar")),
            new QueryStringQueryBuilder("\"bar\"").quoteFieldSuffix(".quote").field(STRING_FIELD_NAME).doToQuery(context)
    ...
    public void testToFuzzyQuery() throws Exception {
        Query query = new QueryStringQueryBuilder("text~2").field(STRING_FIELD_NAME)
            .fuzzyPrefixLength(2)
            .fuzzyMaxExpansions(5)
    ...
    public void testWithStopWords() throws Exception {
        Query query = new QueryStringQueryBuilder("the quick fox").field(STRING_FIELD_NAME).analyzer("stop").toQuery(createShardContext());
        Query expected = new BooleanQuery.Builder().add(new TermQuery(new Term(STRING_FIELD_NAME, "quick")), BooleanClause.Occur.SHOULD)
            .add(new TermQuery(new Term(STRING_FIELD_NAME, "fox")), BooleanClause.Occur.SHOULD)
            .build();
        assertEquals(expected, query);

        query = new QueryStringQueryBuilder("the quick fox").field(STRING_FIELD_NAME)
            .field(STRING_FIELD_NAME_2)
            .analyzer("stop")
            .toQuery(createShardContext());
        expected = new DisjunctionMaxQuery(
            Arrays.asList(
                new BooleanQuery.Builder().add(new TermQuery(new Term(STRING_FIELD_NAME, "quick")), Occur.SHOULD)
                    .add(new TermQuery(new Term(STRING_FIELD_NAME, "fox")), Occur.SHOULD)
                    .build(),
                new BooleanQuery.Builder().add(new TermQuery(new Term(STRING_FIELD_NAME_2, "quick")), Occur.SHOULD)
        ...
        query = new QueryStringQueryBuilder("the").field(STRING_FIELD_NAME)
            .field(STRING_FIELD_NAME_2)
            .analyzer("stop")
            .toQuery(createShardContext());
        assertEquals(new BooleanQuery.Builder().build(), query);

        query = new BoolQueryBuilder().should(new QueryStringQueryBuilder("the").field(STRING_FIELD_NAME).analyzer("stop"))
            .toQuery(createShardContext());
        ...
        query = new BoolQueryBuilder().should(
            new QueryStringQueryBuilder("the").field(STRING_FIELD_NAME).field(STRING_FIELD_NAME_2).analyzer("stop")
        ).toQuery(createShardContext());
        assertEquals(expected, query);
    }

    public void testEnablePositionIncrement() throws Exception {
        Query query = new QueryStringQueryBuilder("\"quick the fox\"").field(STRING_FIELD_NAME)
            .analyzer("stop")
            .enablePositionIncrements(false)
            .toQuery(createShardContext());
        PhraseQuery expected = new PhraseQuery.Builder().add(new Term(STRING_FIELD_NAME, "quick"))
    ...
    public void testWithPrefixStopWords() throws Exception {
        Query query = new QueryStringQueryBuilder("the* quick fox").field(STRING_FIELD_NAME).analyzer("stop").toQuery(createShardContext());
        BooleanQuery expected = new BooleanQuery.Builder().add(new PrefixQuery(new Term(STRING_FIELD_NAME, "the")), Occur.SHOULD)
    ...
    public void testPhraseSlop() throws Exception {
        Query query = new QueryStringQueryBuilder("quick fox").field(STRING_FIELD_NAME)
        ...
        query = new QueryStringQueryBuilder("quick fox").field(STRING_FIELD_NAME)
            .type(MultiMatchQueryBuilder.Type.PHRASE)
            .phraseSlop(2)
            .toQuery(createShardContext());

        expected = new PhraseQuery.Builder().add(new Term(STRING_FIELD_NAME, "quick"))
            .add(new Term(STRING_FIELD_NAME, "fox"))
            .setSlop(2)
            .build();
        assertEquals(expected, query);

        query = new QueryStringQueryBuilder("\"quick fox\"").field(STRING_FIELD_NAME).phraseSlop(2).toQuery(createShardContext());
        assertEquals(expected, query);

        query = new QueryStringQueryBuilder("\"quick fox\"~2").field(STRING_FIELD_NAME).phraseSlop(10).toQuery(createShardContext());
        assertEquals(expected, query);
    }

    public void testAnalyzedPrefix() throws Exception {
        Query query = new QueryStringQueryBuilder("quick* @&*").field(STRING_FIELD_NAME)
            .analyzer("standard")
    ...
    public void testNegativeFieldBoost() {
        IllegalArgumentException exc = expectThrows(
            ...
            () -> new QueryStringQueryBuilder("the quick fox").field(STRING_FIELD_NAME, -1.0f)
                .field(STRING_FIELD_NAME_2)
                .toQuery(createShardContext())
        );
    ...
    private void assertQueryWithAllFieldsWildcard(Query query) {
        ...
        assertThat(
            ...
            hasItems(new TermQuery(new Term(STRING_FIELD_NAME, "hello")), new TermQuery(new Term(STRING_FIELD_NAME_2, "hello")))
        );
    }
