...
public class SimpleQueryStringBuilderTests extends AbstractQueryTestCase<SimpleQueryStringBuilder> {
    ...
    public void testAnalyzeWildcard() throws IOException {
        ...
        SimpleQueryStringQueryParser parser = new SimpleQueryStringQueryParser(
            ...
            Collections.singletonMap(STRING_FIELD_NAME, 1.0f),
            -1,
            settings,
            createShardContext()
        );
    ...
    public void testAnalyzerWithGraph() {
        ...
        for (Operator op : Operator.values()) {
            ...
            Query expectedQuery = new BooleanQuery.Builder().add(
                new BooleanClause(new TermQuery(new Term(STRING_FIELD_NAME, "guinea")), defaultOp)
            ).add(new BooleanClause(new TermQuery(new Term(STRING_FIELD_NAME, "pig")), defaultOp)).build();
            assertThat(query, equalTo(expectedQuery));
            ...
            PhraseQuery pq1 = new PhraseQuery.Builder().add(new Term(STRING_FIELD_NAME, "tiny"))
                .add(new Term(STRING_FIELD_NAME, "guinea"))
                .add(new Term(STRING_FIELD_NAME, "pig"))
                .setSlop(2)
                .build();
            PhraseQuery pq2 = new PhraseQuery.Builder().add(new Term(STRING_FIELD_NAME, "tiny"))
                .add(new Term(STRING_FIELD_NAME, "cavy"))
                .setSlop(2)
                .build();

            expectedQuery = new BooleanQuery.Builder().add(new TermQuery(new Term(STRING_FIELD_NAME, "big")), defaultOp)
                .add(
    ...
    public void testAllFieldsWildcard() throws Exception {
        ...
        query = new SimpleQueryStringBuilder("hello").field(STRING_FIELD_NAME).field("*").field(STRING_FIELD_NAME_2).toQuery(context);
        assertQueryWithAllFieldsWildcard(query);
    }

    public void testToFuzzyQuery() throws Exception {
        Query query = new SimpleQueryStringBuilder("text~2").field(STRING_FIELD_NAME)
            .fuzzyPrefixLength(2)
    ...
    public void testWithStopWords() throws Exception {
        Query query = new SimpleQueryStringBuilder("the quick fox").field(STRING_FIELD_NAME).analyzer("stop").toQuery(createShardContext());
        ...
        query = new SimpleQueryStringBuilder("the quick fox").field(STRING_FIELD_NAME)
            .field(STRING_FIELD_NAME_2)
            .analyzer("stop")
            .toQuery(createShardContext());
        expected = new BooleanQuery.Builder().add(
            new DisjunctionMaxQuery(
                Arrays.asList(new TermQuery(new Term(STRING_FIELD_NAME, "quick")), new TermQuery(new Term(STRING_FIELD_NAME_2, "quick"))),
                1.0f
            ),
            ...
            .add(
                new DisjunctionMaxQuery(
                    Arrays.asList(new TermQuery(new Term(STRING_FIELD_NAME, "fox")), new TermQuery(new Term(STRING_FIELD_NAME_2, "fox"))),
                    1.0f
                ),
                BooleanClause.Occur.SHOULD
            )
        ...
        query = new SimpleQueryStringBuilder("the").field(STRING_FIELD_NAME)
            .field(STRING_FIELD_NAME_2)
            .analyzer("stop")
            .toQuery(createShardContext());
        assertEquals(new MatchNoDocsQuery(), query);

        query = new BoolQueryBuilder().should(new SimpleQueryStringBuilder("the").field(STRING_FIELD_NAME).analyzer("stop"))
            .toQuery(createShardContext());
        ...
        query = new BoolQueryBuilder().should(
            new SimpleQueryStringBuilder("the").field(STRING_FIELD_NAME).field(STRING_FIELD_NAME_2).analyzer("stop")
        ).toQuery(createShardContext());
        assertEquals(expected, query);
    }

    public void testWithPrefixStopWords() throws Exception {
        Query query = new SimpleQueryStringBuilder("the* quick fox").field(STRING_FIELD_NAME)
            .analyzer("stop")
            .toQuery(createShardContext());
        BooleanQuery expected = new BooleanQuery.Builder().add(
            new PrefixQuery(new Term(STRING_FIELD_NAME, "the")),
            BooleanClause.Occur.SHOULD
        )
    ...
    public void testUnmappedFieldNoTokenWithAndOperator() throws IOException {
        Query query = new SimpleQueryStringBuilder("first & second").field(STRING_FIELD_NAME)
            .field("unmapped")
        ...
        ).add(new TermQuery(new Term(STRING_FIELD_NAME, "second")), BooleanClause.Occur.MUST).build();
        assertEquals(expected, query);
    ...
    public void testNegativeFieldBoost() {
        IllegalArgumentException exc = expectThrows(
            ...
            () -> new SimpleQueryStringBuilder("the quick fox").field(STRING_FIELD_NAME, -1.0f)
                .field(STRING_FIELD_NAME_2)
                .toQuery(createShardContext())
        );
