...
public class FetchSourceSubPhaseTests extends ESTestCase {
    ...
    public void testNestedSource() throws IOException {
        ...
        XContentBuilder source = XContentFactory.jsonBuilder()
            ...
            .endObject();
        FetchSubPhase.HitContext hitContext = hitExecuteMultiple(
            source,
            true,
            null,
            null,
    ...
    public void testNestedSourceWithSourceDisabled() {
        FetchSubPhase.HitContext hitContext = hitExecute(null, true, null, null, new SearchHit.NestedIdentity("nested1", 0, null));
        assertNull(hitContext.hit().getSourceAsMap());
    ...
    private FetchSubPhase.HitContext hitExecute(
    ...
    private FetchSubPhase.HitContext hitExecuteMultiple(
        ...
        SearchContext searchContext = new FetchSourceSubPhaseTestSearchContext(
            fetchSourceContext,
