...
public class DateHistogramAggregatorTests extends AggregatorTestCase {
    ...
    public void testNoDocsDeprecatedInterval() throws IOException {
        ...
        testSearchAndReduceCase(query, dates, aggregation, histogram -> assertNull(histogram), false);
        assertWarnings("[interval] on [date_histogram] is deprecated, use [fixed_interval] or [calendar_interval] in the future.");
    }
    ...
    public void testNoDocs() throws IOException {
        Query query = new MatchNoDocsQuery();
        List<String> dates = Collections.emptyList();
        Consumer<DateHistogramAggregationBuilder> aggregation = agg -> agg.calendarInterval(DateHistogramInterval.YEAR).field(DATE_FIELD);
        testSearchCase(query, dates, aggregation, histogram -> assertEquals(0, histogram.getBuckets().size()), false);
        testSearchAndReduceCase(query, dates, aggregation, histogram -> assertNull(histogram), false);

        aggregation = agg -> agg.fixedInterval(new DateHistogramInterval("365d")).field(DATE_FIELD);
        testSearchCase(query, dates, aggregation, histogram -> assertEquals(0, histogram.getBuckets().size()), false);
        testSearchAndReduceCase(query, dates, aggregation, histogram -> assertNull(histogram), false);
    }
    ...
    public void testIntervalYearDeprecated() throws IOException {
        testBothCases(
            LongPoint.newRangeQuery(INSTANT_FIELD, asLong("2015-01-01"), asLong("2017-12-31")),
            dataset,
            aggregation -> aggregation.dateHistogramInterval(DateHistogramInterval.YEAR).field(DATE_FIELD),
            histogram -> {
    ...
    public void testMaxBucket() throws IOException {
        Query query = new MatchAllDocsQuery();
        List<String> timestamps = Arrays.asList("2010-01-01T00:00:00.000Z", "2011-01-01T00:00:00.000Z", "2017-01-01T00:00:00.000Z");
        ...
        expectThrows(
            ...
            () -> testSearchAndReduceCase(
                query,
                timestamps,
                aggregation -> aggregation.fixedInterval(DateHistogramInterval.seconds(5))
                    .field(DATE_FIELD)
                    .subAggregation(
                        AggregationBuilders.dateHistogram("1").fixedInterval(DateHistogramInterval.seconds(5)).field(DATE_FIELD)
                    ),
                histogram -> {},
                5,
                false
    ...
    public void testMaxBucketDeprecated() throws IOException {
        ...
        expectThrows(
            ...
            () -> testSearchAndReduceCase(
                query,
                timestamps,
                aggregation -> aggregation.dateHistogramInterval(DateHistogramInterval.seconds(5))
                    .field(DATE_FIELD)
                    .subAggregation(
                        AggregationBuilders.dateHistogram("1").dateHistogramInterval(DateHistogramInterval.seconds(5)).field(DATE_FIELD)
                    ),
                histogram -> {},
                5,
                false
    ...
    public void testNewThenLegacy() throws IOException {
        ...
        e = expectThrows(
            ...
            () -> testSearchCase(
                new MatchAllDocsQuery(),
                Arrays.asList("2017-02-01", "2017-02-02", "2017-02-02", "2017-02-03", "2017-02-03", "2017-02-03", "2017-02-05"),
                aggregation -> aggregation.fixedInterval(new DateHistogramInterval("2d")).interval(1000).field(DATE_FIELD),
                histogram -> {},
                false
            )
        );
        ...
        e = expectThrows(
            ...
            () -> testSearchCase(
                new MatchAllDocsQuery(),
                Arrays.asList("2017-02-01", "2017-02-02", "2017-02-02", "2017-02-03", "2017-02-03", "2017-02-03", "2017-02-05"),
                aggregation -> aggregation.calendarInterval(DateHistogramInterval.DAY).interval(1000).field(DATE_FIELD),
                histogram -> {},
                false
            )
        );
    ...
    public void testLegacyThenNew() throws IOException {
        ...
        e = expectThrows(
            ...
            () -> testSearchCase(
                new MatchAllDocsQuery(),
                Arrays.asList("2017-02-01", "2017-02-02", "2017-02-02", "2017-02-03", "2017-02-03", "2017-02-03", "2017-02-05"),
                aggregation -> aggregation.interval(1000).fixedInterval(new DateHistogramInterval("2d")).field(DATE_FIELD),
                histogram -> {},
                false
            )
        );
        ...
        e = expectThrows(
            ...
            () -> testSearchCase(
                new MatchAllDocsQuery(),
                Arrays.asList("2017-02-01", "2017-02-02", "2017-02-02", "2017-02-03", "2017-02-03", "2017-02-03", "2017-02-05"),
                aggregation -> aggregation.interval(1000).calendarInterval(DateHistogramInterval.DAY).field(DATE_FIELD),
                histogram -> {},
                false
            )
        );
