...
public class MetaDataIndexTemplateServiceTests extends ESSingleNodeTestCase {
    ...
    public void testFindTemplates() throws Exception {
        ...
        assertThat(
            MetaDataIndexTemplateService.findTemplates(state.metaData(), "foo-1234", randomBoolean())
                .stream()
        ...
        assertThat(
            MetaDataIndexTemplateService.findTemplates(state.metaData(), "bar-xyz", randomBoolean())
                .stream()
                .map(IndexTemplateMetaData::name)
                .collect(Collectors.toList()),
            contains("bar")
    ...
    public void testFindTemplatesWithHiddenIndices() throws Exception {
        ...
        // hidden
        assertThat(
            MetaDataIndexTemplateService.findTemplates(state.metaData(), "foo-1234", true)
                .stream()
                .map(IndexTemplateMetaData::name)
                .collect(Collectors.toList()),
        ...
        assertThat(
            MetaDataIndexTemplateService.findTemplates(state.metaData(), "bar-xyz", true)
                .stream()
                .map(IndexTemplateMetaData::name)
                .collect(Collectors.toList()),
            contains("bar")
        ...
        assertThat(
            MetaDataIndexTemplateService.findTemplates(state.metaData(), "sneaky1", true)
                .stream()
                .map(IndexTemplateMetaData::name)
                .collect(Collectors.toList()),
        ...
        // not hidden
        assertThat(
            MetaDataIndexTemplateService.findTemplates(state.metaData(), "foo-1234", false)
                .stream()
                .map(IndexTemplateMetaData::name)
                .collect(Collectors.toList()),
        ...
        assertThat(
            MetaDataIndexTemplateService.findTemplates(state.metaData(), "bar-xyz", false)
                .stream()
                .map(IndexTemplateMetaData::name)
                .collect(Collectors.toList()),
        ...
        assertThat(
            MetaDataIndexTemplateService.findTemplates(state.metaData(), "baz", false)
                .stream()
                .map(IndexTemplateMetaData::name)
                .collect(Collectors.toList()),
            contains("global")
        ...
        assertThat(
            MetaDataIndexTemplateService.findTemplates(state.metaData(), "sneaky1", false)
                .stream()
                .map(IndexTemplateMetaData::name)
                .collect(Collectors.toList()),
        ...
        // unknown
        assertThat(
            MetaDataIndexTemplateService.findTemplates(state.metaData(), "foo-1234", null)
                .stream()
                .map(IndexTemplateMetaData::name)
                .collect(Collectors.toList()),
            containsInAnyOrder("foo-2", "foo-1", "global")
        ...
        assertThat(
            MetaDataIndexTemplateService.findTemplates(state.metaData(), "bar-xyz", null)
                .stream()
                .map(IndexTemplateMetaData::name)
                .collect(Collectors.toList()),
            containsInAnyOrder("bar", "global")
        ...
        assertThat(
            MetaDataIndexTemplateService.findTemplates(state.metaData(), "baz", null)
                .stream()
                .map(IndexTemplateMetaData::name)
                .collect(Collectors.toList()),
            contains("global")
        ...
        assertThat(
            MetaDataIndexTemplateService.findTemplates(state.metaData(), "sneaky1", null)
                .stream()
                .map(IndexTemplateMetaData::name)
                .collect(Collectors.toList()),
            contains("sneaky-hidden")
