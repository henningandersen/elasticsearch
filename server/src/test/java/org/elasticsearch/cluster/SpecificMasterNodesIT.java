...
public class SpecificMasterNodesIT extends ESIntegTestCase {
    ...
    public void testSimpleOnlyMasterNodeElection() throws IOException {
        ...
        final String masterNodeName = internalCluster().startNode(
            Settings.builder().put(Node.NODE_DATA_SETTING.getKey(), false).put(Node.NODE_MASTER_SETTING.getKey(), true)
        );
        assertThat(
    ...
    public void testElectOnlyBetweenMasterNodes() throws Exception {
        ...
        final String nextMasterEligableNodeName = internalCluster().startNode(
            Settings.builder().put(Node.NODE_DATA_SETTING.getKey(), false).put(Node.NODE_MASTER_SETTING.getKey(), true)
        );
        assertThat(
            internalCluster().nonMasterClient()
        ...
        client().execute(AddVotingConfigExclusionsAction.INSTANCE, new AddVotingConfigExclusionsRequest(new String[] { masterNodeName }))
            .get();
    ...
    public void testAliasFilterValidation() {
        ...
        logger.info("--> start data node / non master node");
        internalCluster().startNode(
            Settings.builder().put(Node.NODE_DATA_SETTING.getKey(), true).put(Node.NODE_MASTER_SETTING.getKey(), false)
        );
