...
final class OpenFollowerIndexStep extends AsyncActionStep {
    ...
    OpenFollowerIndexStep(StepKey key, StepKey nextStepKey, IndexLifecycleContext indexLifecycleContext) {
    ...
    public void performAction(IndexMetaData indexMetaData, ClusterState currentClusterState,
        ...
        if (indexMetaData.getState() == IndexMetaData.State.CLOSE) {
            getIndexLifecycleContext().open(indexMetaData.getIndex().getName(), ActionListener.wrap(
                r -> {
