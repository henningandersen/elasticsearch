...
public interface LifecycleAction extends ToXContentObject, NamedWriteable {
     ...
     * @param indexLifecycleContext      the client that will be used by {@link AsyncActionStep} and {@link AsyncWaitStep} steps
     ...
     */
    List<Step> toSteps(IndexLifecycleContext indexLifecycleContext, String phase, @Nullable Step.StepKey nextStepKey);
