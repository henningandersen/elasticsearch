...
public class ReactiveStorageDeciderServiceTests extends AutoscalingTestCase {
    ...
    public void validateSizeOf(
        ...
        ClusterInfo info = new ClusterInfo(null, null, shardSizeBuilder.build(), dataSetShardSizes, null, null);
    ...
    public void testUnmovableSize() {
        ...
        ClusterInfo info = new ClusterInfo(diskUsages, diskUsages, shardSizeBuilder.build(), dataSetShardSizes, null, null);
