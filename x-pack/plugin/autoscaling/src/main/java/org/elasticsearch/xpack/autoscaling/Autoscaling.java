...
public class Autoscaling extends Plugin implements ActionPlugin, ExtensionPlugin, AutoscalingPlugin {
    ...
    public Autoscaling(final Settings settings) {
        ...
        logger.info("Classloader: " + this.getClass().getClassLoader() + ", " + AutoscalingPlugin.class.getClassLoader());
    ...
    public List<NamedXContentRegistry.Entry> getNamedXContent() {
        return List.of(
            ...
            new NamedXContentRegistry.Entry(ReactiveStorageDecider.class, new ParseField(ReactiveStorageDecider.NAME),
    ...
    public <O> void extend(Extender extender) {
        extender.extend(AutoscalingPlugin.class).addLazySet(new TypeLiteral<>() {}, AutoscalingPlugin::deciders);
    }
